...
export default class BunchOfStems extends React.Component {
  ...
  render() {
    return (
      <React.Fragment>
        <div className="stem" style={this.props.state[0].stem.style}>
          <div className={`knot ${this.props.state[0].knots[0].type}`} style={this.props.state[0].knots[0].style}/>
          <div className={`knot ${this.props.state[0].knots[1].type}`} style={this.props.state[0].knots[1].style}/>
          <div className={`knot ${this.props.state[0].knots[2].type}`} style={this.props.state[0].knots[2].style}/>
        </div>
        <div className="stem" style={this.props.state[1].stem.style}>
        ...
        <div className="stem" style={this.props.state[2].stem.style}>
        ...
        <div className="stem" style={this.props.state[3].stem.style}>
          <div className="knot" style={{top: '150px'}}/>
          <div className="knot" style={{top: '320px'}}/>
          <div className="knot" style={{top: '440px'}}/>
        </div>
        <div className="stem" style={this.props.state[4].stem.style}>
